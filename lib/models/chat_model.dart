class ChatModel {
  ...
  factory ChatModel.fromMap(Map<String, dynamic> map) {
    ...
    if (map['lastSeenBy'] != null) {
      Map<String, dynamic> rawLastSeen =
          Map<String, dynamic>.from(map['lastSeenBy']);
    ...
    if (map['deletedAt'] != null) {
      Map<String, dynamic> rawDeletedAt =
          Map<String, dynamic>.from(map['deletedAt']);
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'deletedBy': deletedBy,
      'deletedAt':
          deletedAt.map((k, v) => MapEntry(k, v?.millisecondsSinceEpoch)),
      'lastSeenBy':
          lastSeenBy.map((k, v) => MapEntry(k, v?.millisecondsSinceEpoch)),
